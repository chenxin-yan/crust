...
export const siteConfig = {
	...
	titleTemplate: (page?: string) =>
		page ? `${page} | CrustJS CLI Framework` : "CrustJS - TypeScript CLI Framework",
	defaultDescription: "A TypeScript CLI framework with composable modules for humans and agents.",
	...
	return [
		...
		},
		{
			...
			children: JSON.stringify({
				...
				runtimePlatform: ["Bun", "Node.js", "Deno"],
