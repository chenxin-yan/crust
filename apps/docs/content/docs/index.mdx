...
- **Commands and input parsing.** Nested [commands](/docs/guide/commands), [arguments and flags](/docs/guide/inputs) with aliases, defaults, choices, [Standard Schema validation](/docs/guide/types#schema-backed-definitions), and inferred types.
