...
- **Bun-first, runtime-portable** — Crust tooling builds standalone Bun binaries, while the library packages have first-class support for Bun, Node.js 22+, and Deno 2.8+ through shared `node:` APIs.
