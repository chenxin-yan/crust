...
- **TypeScript-first definitions.** Collisions and malformed definitions fail at their authoring call sites during type checking; argv is still validated at runtime.
