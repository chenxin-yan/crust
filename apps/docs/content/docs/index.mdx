...
- **Commands and input parsing.** Nested [commands](/docs/guide/subcommands), positional [arguments](/docs/guide/arguments), and [flags](/docs/guide/flags) with aliases, defaults, choices, [Standard Schema validation](/docs/guide/types#schema-backed-definitions), and inferred types.
