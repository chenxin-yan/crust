...
The flag is parsed and shown in help at each descendant. Declare inherited flags before creating a child with `.sub()`; see [Split Commands Across Files](/docs/guide/split-files).
