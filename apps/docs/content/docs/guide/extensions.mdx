...
Commands can declare plain-text documentation sections in their metadata. Help renders them after Options, and man-page generation emits one mdoc section per entry:
...
Extensions can append sections to any command after the application tree is prepared:
