...
A parent with a Command Action treats unmatched argv command tokens as positional arguments. Typed `run()` rejects unknown path segments. See [Unknown commands](/docs/guide/subcommands#unknown-commands).
