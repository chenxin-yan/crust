...
If the root has its own `.action()`, matching subcommands still take priority. Unmatched words are parsed as the root's [positional arguments](/docs/guide/inputs#arguments) instead.
