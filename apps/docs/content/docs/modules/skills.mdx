...
interface SkillOptions {
  version: string; // compared against installed crust.json
...
interface CustomSkillConfig {
  ...
  version?: string; // inherits Extension `version` when omitted
  scope?: "global" | "project"; // overrides Extension defaultScope
  installMode?: "auto" | "symlink" | "copy";
}
```
