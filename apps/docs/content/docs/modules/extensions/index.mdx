...
<include lang="ts" meta='title="cli.ts"'>
  ../../../../examples/modules/extensions/index.ts
</include>
...
A curated list of the runtime exports; the [package entry point](https://github.com/chenxin-yan/crust/blob/main/packages/extensions/src/index.ts) also exports each option type.
