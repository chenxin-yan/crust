...
| `CommandSnapshot`     | Readonly command description; the root includes Extension data       |
| `ExtensionSnapshot`   | Loaded Extension identity and optional tooling metadata              |
...
| `ExtensionConfig`       | Owned flags, commands, per-command sections, tooling metadata, and hooks    |
