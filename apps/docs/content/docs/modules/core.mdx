...
| `ExtensionConfig`       | Ordering, owned flags, commands, section contributions, build generation, and hooks |
...
```ts
import { defineExtensionId, sectionsFor, type CommandSection } from "@crustjs/core";
