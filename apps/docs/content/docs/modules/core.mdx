...
| `CommandContract`       | Argument, flag, children, and action result contract of one command           |
| `CommandContractAtPath` | Resolve the command contract at a typed path                                  |
...
| `RunInputArguments`     | Input tuple for a contract: optional when nothing is required                 |
