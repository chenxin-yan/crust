...
function _typecheckKeepsTransitiveContextDependencyClosuresAtConstantDepth() {
	...
	const d2 = defineContext("d2", { use: [d1] }, () => 2);
	const d3 = defineContext("d3", { use: [d2] }, () => 3);
	const d4 = defineContext("d4", { use: [d3] }, () => 4);
	const d5 = defineContext("d5", { use: [d4] }, () => 5);
	const d6 = defineContext("d6", { use: [d5] }, () => 6);
	const d7 = defineContext("d7", { use: [d6] }, () => 7);
	const d8 = defineContext("d8", { use: [d7] }, () => 8);
	new Crust("deep")
		.provide(d1())
		.provide(d2())
		.provide(d3())
