...
{
	// brands an unsatisfied dependency and accepts same-batch providers
...
{
	// opts widened instance dependency maps out of the missing-dependency brand
...
{
	// brands sealed-unit dependencies and opts widened contracts out
...
{
	// brands a name already provided in an earlier call
...
{
	// brands both occurrences of a same-call duplicate
...
{
	// opts widened names and registries out
	...
	type WidenedRegistry = ValidateContextNames<Record<string, ContextValue>, readonly [Inst<"db">]>;
