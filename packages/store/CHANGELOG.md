...
- [#307](https://github.com/chenxin-yan/crust/pull/307) [`e3b196a`](https://github.com/chenxin-yan/crust/commit/e3b196a0d300790b95e9417324b05ae2371d24ce) Thanks [@chenxin-yan](https://github.com/chenxin-yan)! - Tighten the store definition, persistence, and error surface (breaking).
...
- [#339](https://github.com/chenxin-yan/crust/pull/339) [`948ae46`](https://github.com/chenxin-yan/crust/commit/948ae465650e815d26f9f1edac104c1206763a4d) Thanks [@chenxin-yan](https://github.com/chenxin-yan)! - Materialize schema defaults before `update()` callbacks and `patch()` merges so mutation inputs match their inferred store types, without revalidating transformed defaults during `read()`.
