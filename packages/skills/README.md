...
Root help and generated man pages include an **Agent skills** section with each shipped skill's name, description, and resolved logical source path. If the path is unavailable, help remains usable and points to the `skill` command instead.
